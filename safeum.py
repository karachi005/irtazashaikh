...
Ya_Bs = '\033[1;34m'
S_aBs = '\033[1;33m'
ab = pyfiglet.figlet_format("×͜×IRTAZA×͜×")
print(a_bSa + ab)
...
to(
    f"\033[31;m Script Type>> \033[1;36mSafeUm Vip Account Generetor IRTAZA SHAIKH\n\033[1;31m Script\n\033[31;m Time >>\033[1;33mUnlimited\n\033[31;m")
print('')
print('\033[32;m')
...
def work():
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
            with open('irtaza_safeum.txt', 'a') as f:
...
while True:
    ...
    if int(success) > int(0):
        ...
        print("Account Generated>> Devolper : IRTAZA SHAIKH\n", z)
